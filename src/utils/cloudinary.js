...
export const cloudinaryStories = [
    ...
    // ------------------ בר מצווה ------------------
    {
        ...
        images: [
            { publicId: "DSC_4420_id3np7", alt: "תמונת בר מצווה", caption: "רגעים מיוחדים" },
            { publicId: "DSC_6389_lvkbcf", alt: "תמונת בר מצווה", caption: "רגעים מיוחדים" },
            { publicId: "DSC_6748_bpe6wn", alt: "תמונת בר מצווה", caption: "רגעים מיוחדים" },
            { publicId: "DSC_8466_qswjjm", alt: "תמונת בר מצווה", caption: "רגעים מיוחדים" },
            { publicId: "DSC_8480_lcilrb", alt: "תמונת בר מצווה", caption: "רגעים מיוחדים" },
        ],
    },
    ...
    // ------------------ בת מצווה ------------------
    {
        ...
        images: [
            { publicId: "DSC_8525_rvlafa", alt: "תמונת בת מצווה", caption: "רגעים מיוחדים" },
            { publicId: "DSC_8655_lhbwvp", alt: "תמונת בת מצווה", caption: "רגעים מיוחדים" },
            { publicId: "DSC_8718_uvvwit", alt: "תמונת בת מצווה", caption: "רגעים מיוחדים" },
            { publicId: "DSC_9654_j1ntwn", alt: "תמונת בת מצווה", caption: "רגעים מיוחדים" },
            { publicId: "DSC_9686_tzgm2w", alt: "תמונת בת מצווה", caption: "רגעים מיוחדים" },
        ],
    },
    ...
    // ------------------ אירועים ------------------
    {
        ...
        images: [
            { publicId: "DSC_9693_nj30cp",   alt: "תמונת אירוע", caption: "רגעים מיוחדים" },
            { publicId: "DSC_1533_wghbkf",   alt: "תמונת אירוע", caption: "רגעים מיוחדים" },
            { publicId: "צלם_1_199_g0uvak",  alt: "תמונת אירוע", caption: "רגעים מיוחדים" },
            { publicId: "צלם_1_1291_bfa4pz", alt: "תמונת אירוע", caption: "רגעים מיוחדים" },
            { publicId: "צלמת_2_316_gdz0ck", alt: "תמונת אירוע", caption: "רגעים מיוחדים" },
        ],
    },
];
